        ...
        if (snapshot.hasData) {
          ...
          return Container(
            ...
            child: IconButton(
              ...
              onPressed: DiscoverService.getBannerList(),
            ),
          );
        }
...
class RecommendedSongList extends StatelessWidget {
  final Future recommendSongList;
    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          FutureBuilder(
            future: recommendSongList,
            builder: (BuildContext context, snapshot) {
              if (snapshot.hasData) {
                final List list = snapshot.data['result'];
                // 截取前六个
                final int len = list.length > 6 ? 6 : list.length;
                // 圆角值
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Text(
                                      "${Utils.getNumToWan(list[index]['playCount']).toString()}万",
                                      style: TextStyle(
                                        color: Colors.white,
                                        fontSize: 11,
                                      ),
                  ...
                  builder: (BuildContext context, snapshot) {
                    if (snapshot.hasData) {
                      ...
                      return Container(
                        ...
                        child: IconButton(
                          icon: Icon(Icons.refresh),
                          onPressed: DiscoverService.getNewAlbumList(const {
                            "offset": 0,
                            "limit": 3
                          }),
                        ),
                  ...
                  builder: (BuildContext context, snapshot) {
                    if (snapshot.hasData) {
                                ...
                                children: <Widget>[
                                  ...
                                  Positioned(
                                    ...
                                    child: Container(
                                      ...
                                      child: Image.asset("assets/images/play.png", width: 20, color: Constants.themeColor,),
                                    ),
                                  )
                                ],
                              ),
                      ...
                      return Container(
                        ...
                        child: IconButton(
                          icon: Icon(Icons.refresh),
                          onPressed: DiscoverService.getNewSongList(),
                        ),
                      );
                    }
